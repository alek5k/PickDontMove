...
class SimioPickDontMoveEnv(gym.Env):
    def __init__(self, num_locations=8, num_pickers=1, num_agvs=2, max_order_qty=20, log_output=False, log_end_episode_only=False):
        ''' 
    ...
    def parse_message(self, message):
        ...
        state_variables = []
        state_variables.append(message['PickerLocation'])
        state_variables.append(message['AGV1Location'])
        state_variables.append(message['AGV2Location'])
        state_variables.append(message['AGV1RemainingOrderQuantities'])
        state_variables.append(message['AGV2RemainingOrderQuantities'])

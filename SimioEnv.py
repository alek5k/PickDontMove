...
class SimioPickDontMoveSimplifiedEnv(gym.Env):
    ...
    def parse_message(self, message):
        ...
        if self.log_output:
            if self.log_end_episode_only:
                if done:
                    print("Status: ", status, ", EpisodeNum: ", episode_num, ", Reward: ", reward, ", States: ", states)
            else:
                print("Status: ", status, ", EpisodeNum: ", episode_num, ", Reward: ", reward, ", States: ", states)
            
        
        return (self.flatten_state(states), reward, done, None)
